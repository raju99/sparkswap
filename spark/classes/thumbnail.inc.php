<?php //File is added to create thumbnails of images.
/**
 * thumbnail.inc.php
 * 
...
//$imgname = "http://maduhaa.com/images/nopic1ghhhhhhhhhhhhh.JPG";
$imgname ="http://".$_SERVER['SERVER_NAME']."/blancsquare/images/white.jpg";
//print_r($errImg);
